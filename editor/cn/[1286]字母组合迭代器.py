...
#  
# 
#  Related Topics 设计 字符串 回溯 迭代器 👍 82 👎 0
...
class CombinationIterator:
    ...
    def __init__(self, characters: str, combinationLength: int):
        self.combin = combinations(characters,combinationLength)
        self.length = comb(len(characters),combinationLength)

    def next(self) -> str:
        self.length -= 1
        return ''.join(self.combin.__next__())
